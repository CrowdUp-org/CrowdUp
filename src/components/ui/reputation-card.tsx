...
import { REPUTATION_LEVELS, ReputationLevel, getReputationData } from "@/lib/reputation";
...
export function ReputationCard({ score, level, className = "" }: ReputationCardProps) {
    ...
    // Get next level info
    const levelOrder: ReputationLevel[] = ['newcomer', 'contributor', 'established', 'trusted', 'expert', 'legend'];
