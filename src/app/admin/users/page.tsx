...
import { getAllUsers, updateUserAdminStatus, isCurrentUserAdmin } from "@/lib/verification";
            ...
            <main className="mx-auto max-w-6xl px-6 pt-24 pb-12">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Manage platform moderators and view community activity</p>
                    </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50 border-b">
                                ...
                                <th className="px-6 py-4 font-semibold text-gray-700">Reputation</th>
                                    ...
                                    <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <Button
                                                ...
                                                size="sm"
                                                className={user.is_admin ? "text-red-600 hover:text-red-700 hover:bg-red-50" : "bg-blue-600 hover:bg-blue-700"}
